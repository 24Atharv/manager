...
export const Navbar = () => {
    return <div className="border border-gray-100 shadow-2xs rounded-lg p-3 flex items-center justify-between hover:shadow-2xl">
        <div className="flex items-center">
            <LeafIcon />
            <span className="hidden sm:inline sm:text-gray-900 sm:text-2xl">tymeline</span>
        </div>
        <div className="flex items-center gap-2 sm:gap-5 cursor-pointer">
            <SunIcon />
            <span className="hidden sm:inline bg-white border border-gray-400 text-gray-900 rounded py-2 px-4 text-xl hover:shadow-2xl">
                Log in
            </span>
